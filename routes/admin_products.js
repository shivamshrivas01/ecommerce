...
router.post("/add-product", function (req, res) {
  var imageFile =
    req.files != null && typeof req.files.image !== "undefined"
  ...
  req
    .checkBody("originalPrice", "originalPrice must have a value.")
    .isDecimal();
  req
    .checkBody("discountedPrice", "discountedPrice must have a value.")
    .isDecimal();
    ...
    Product.findOne({ slug: slug }, function (err, product) {
      if (product) {
        ...
        product.save(function (err) {
          ...
          mkdirp(
            publicPath + "/product_images/" + product._id + "/gallery"
          ).then((made) => console.log(`directory created ${made}`));

          mkdirp(
            publicPath + "/product_images/" + product._id + "/gallery/thumbs"
          ).then((made) => console.log(`directory created ${made}`));
